<template>
  ...
  >
    <q-toolbar slot="header">
      ...
      <q-toolbar-title name="mytitile">
        {{ title }} － 北艾
        <div slot="subtitle"> 全球最大的{{ subtitle }} </div>
      </q-toolbar-title>
    </q-toolbar>
    ...
    <div slot="left">
      ...
      <q-list no-border link inset-delimiter>
        ...
        <q-side-link to="home" class="q-item">
          <q-item-side icon="school" />
          <q-item-main label="Home" sublabel="quasar-framework.org" />
        </q-side-link>
        <q-side-link to="news" class="q-item">
          <q-item-side icon="school" />
          <q-item-main label="News" sublabel="quasar-framework.org" />
        </q-side-link>
        <q-side-link to="setting" class="q-item">
          <q-item-side icon="school" />
          <q-item-main label="Setting" sublabel="quasar-framework.org" />
        </q-side-link>
